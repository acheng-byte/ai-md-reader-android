...
项目完全开源，目标是在保持轻量级的前提下，逐步补齐 AI 辅助编码与 AI 内容消费中的高频场景。
...
1. 打开应用，点击右上角“打开”，从系统文件选择器选择 Markdown 文件。
2. 点击工具栏“源码 / 预览”，在原始文本与渲染结果之间切换。
3. 点击“目录”，从左侧目录快速跳转到标题位置。
4. 在预览模式下点击标题，可折叠或展开该章节内容。
5. 点击“显示设置”，调整字号、行间距、段间距和主题。
6. 在微信收到 `.md` 文件时，选择“用其他应用打开”，再选择“MD阅读器”。
...
欢迎提交 issue、PR 和真实使用场景。这个项目会尽量保持朴素、轻巧、可维护。
